...
const custFind = async ()=>{
    let cust = await custModel.find({}).populate("orders");//  jabh muje purri information chyeea hoti h apni object ke tabh hum populate ka use krte h
    console.log(cust);
}
custFind();
